...
std::string WriteTreeWithParentSHA(std::string tree_sha,
                                   std::string parent_commit_sha,
                                   std::string commit_message) {}
std::string WriteTreeWithInitialCommit(std::string tree_sha,
                                       std::string commit_message) {
  std::string timestamp = 某个获取UNIX时间戳的系统调用;
  std::string content = "tree + " + tree_sha + " " + " author " + AUTHOR + " " +
                        EMAIL + " " + timestamp + " committer " + AUTHOR + " " +
                        EMAIL + " " + timestamp + commit_message;
  std::string sha = 
}